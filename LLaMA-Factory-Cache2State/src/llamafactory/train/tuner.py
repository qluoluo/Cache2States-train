...
from .hh_sft import run_hh_sft
from .hedgehog import run_hh
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == 'hh':
        run_hh(model_args, data_args, training_args, finetuning_args, callbacks)
    elif finetuning_args.stage == 'hh_sft':
        run_hh_sft(model_args, data_args, training_args, finetuning_args, callbacks)
    else:
