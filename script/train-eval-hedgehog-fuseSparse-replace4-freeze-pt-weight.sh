...
wait
sleep 3
llamafactory-cli train ./examples/custom/llama3.2_replace4-fuseSparse_hedgehog-freeze-pt-weight.yaml
wait
echo "### end train ###"
sleep 60
...
sleep 5
opencompass myEval/hedgehog-fuse/eval-replace4-fuseSparse_ckpt-freeze-pt-weight.py
wait
sleep 5
