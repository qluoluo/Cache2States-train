...
wait
sleep 3
llamafactory-cli train ./examples/custom/llama3.2_replace4-fuseFull_hedgehog-freeze-sft-weight.yaml
wait
echo "### end train ###"
sleep 60
...
sleep 5
opencompass myEval/hedgehog-fuse/eval-replace4-fuseFull_ckpt-weight.py
wait
sleep 5
