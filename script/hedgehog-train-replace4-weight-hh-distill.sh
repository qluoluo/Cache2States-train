...
wait
sleep 3
llamafactory-cli train ./examples/custom/llama3.2_replace4_hedgehog-freeze-hh-sft.yaml
wait
echo "### end train ###"
sleep 60
...
sleep 5
opencompass myEval/hedgehog-fuse/eval-replace4-fuseFull-sft_ckpt.py
wait
sleep 5
